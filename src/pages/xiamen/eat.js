...
import { Anchor, Modal, Button } from 'antd';
      ...
      >
        ...
        >
          <Anchor
            ...
            style={{ margin: '0 16px', fontSize: '13px' }}
            onClick={this.hideModal}
          >
            <Link href="#cnt_1" title="沙茶面" />
            <Link href="#cnt_2" title="海鲜大餐" />
            <Link href="#cnt_3" title="海蛎煎" />
            <Link href="#cnt_4" title="土笋冻" />
            <Link href="#cnt_5" title="叶氏麻糍" />
            <Link href="#cnt_6" title="烧仙草" />
            <Link href="#cnt_7" title="花生汤" />
            <Link href="#cnt_8" title="炸五香" />
            <Link href="#cnt_9" title="烧肉粽" />
            <Link href="#cnt_10" title="鱼丸汤" />
          </Anchor>
        </Modal>
            ...
            <li id="cnt_6">
              ...
              <small>
                ...
                <ol>
                  ...
                  <li>
                    >店名：仙草南路地址：思明区思明南路158号安定广场152号之3
                  </li>
                </ol>
              </small>
            </li>
