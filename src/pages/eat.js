        ...
        <div className="content">
            <nav style={{
                ...
                <ol style={{ margin: '0 24px', fontSize: '13px' }}>
                    ...
                    <li style={{ display: 'inline-block', margin: '0 8px' }}><a href="#cnt_4">#土笋冻</a></li>
                    <li style={{ display: 'inline-block', margin: '0 8px' }}><a href="#cnt_5">#叶氏麻糍</a></li>
                    <li style={{ display: 'inline-block', margin: '0 8px' }}><a href="#cnt_6">#烧仙草</a></li>
                    <li style={{ display: 'inline-block', margin: '0 8px' }}><a href="#cnt_7">#花生汤</a></li>
                    <li style={{ display: 'inline-block', margin: '0 8px' }}><a href="#cnt_8">#炸五香</a></li>
                    <li style={{ display: 'inline-block', margin: '0 8px' }}><a href="#cnt_9">#烧肉粽</a></li>
                    <li style={{ display: 'inline-block', margin: '0 8px' }}><a href="#cnt_10">#鱼丸汤</a></li>
                </ol>
            </nav>
            <ul>
                <li id="cnt_1" style={{ paddingTop: '48px' }}>
                    <h4>沙茶面</h4>
                ...
                <li id="cnt_2" style={{ paddingTop: '48px' }}>
                    <h4>海鲜大餐</h4>
                    <p>来厦门当然要吃海鲜，满街的海鲜大排档让人口水直流。海蟹、花蛤、鲍鱼、鱿鱼等，原汁原味的海鲜配上厦门独特的酱油水烹调工艺，那滋味真让人回味无穷。厦门吃海鲜的地方众多，但吃之前必须要问清楚价格，货比三家，切莫遇上宰客的商家。</p>
                    <small>推荐
                        <ol>
                            <li>小眼镜大排档；地址：思明区湖滨中路7号。</li>
                            <li>开元141大排档；地址：思明区开元路141-154号。</li>
                        </ol>
                    </small>
                </li>
                <li id="cnt_3" style={{ paddingTop: '48px' }}>
                    <h4>海蛎煎</h4>
                ...
                <li id="cnt_4" style={{ paddingTop: '48px' }}>
                    <h4>土笋冻</h4>
                    ...
                    <small>推荐
                        <ol>
                            ...
                            <li>店名：老二市口土笋冻(幸福路店)；地址：思明区厦禾路386号之5店。</li>
                        </ol>
                    </small>
                </li>
                <li id="cnt_5" style={{ paddingTop: '48px' }}>
                    <h4>叶氏麻糍</h4>
                    ...
                    <small>推荐
                        <ol>
                            ...
                            <li>>店名：叶氏麻糍 　地址：中山路局口街入口对面的工商银行门口的流动摊车。</li>
                        </ol>
                    </small>
                </li>
                <li id="cnt_6" style={{ paddingTop: '48px' }}>
                    <h4>烧仙草</h4>
                ...
                <li id="cnt_9" style={{ paddingTop: '48px' }}>
                    <h4>烧肉粽</h4>
                    ...
                    <small>推荐
                        <ol>
                            ...
                            <li>店名：好清香大酒楼；地址：思明区中山路1号东海大厦酒店6楼。</li>
                        </ol>
                    </small>
                </li>
                <li id="cnt_10" style={{ paddingTop: '48px' }}>
                    <h4>鱼丸汤</h4>
