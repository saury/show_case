...
var storedList = localStorage && localStorage.getItem && localStorage.getItem('backlist');
var storedVersion = localStorage && localStorage.getItem && localStorage.getItem('backlistVersion');
if (!storedList || parseInt(storedVersion) !== parseInt(initData.backListVersion)) {
    backList = initData.backList;
    localStorage && localStorage.setItem && localStorage.setItem('backlist', JSON.stringify(initData));
    localStorage && localStorage.setItem && localStorage.setItem('backlistVersion', initData.backListVersion);
}
else {
...
class NotifyBack extends Component {
    ...
    changeHandler = (idx) => {
        ...
        localStorage && localStorage.setItem && localStorage.setItem('backlist', JSON.stringify({ backList: resultList }));
    }
